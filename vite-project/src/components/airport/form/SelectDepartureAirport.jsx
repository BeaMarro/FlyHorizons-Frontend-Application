...
function SelectDepartureAirport({ airports, setDepartureAirport }) {
  ...
  const handleAirportClick = (airport) => {
    setDepartureAirport(airport.iata_code);
  };
      ...
      <Col sm={3}>
        ...
        <Tab.Container id="left-tabs-example" defaultActiveKey={defaultCountry}>
          <Nav variant="pills" className="flex-column">
            {[...new Set(airports.map((airport) => airport.country))].map((country) => (
